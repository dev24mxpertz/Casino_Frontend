    ...
    return (
        <div className='text-white col-12 d-flex align-items-center header-avtar'>
            <Tooltip placement='left' title={'notification'}>
                <IconButton size="large" aria-label="show 17 new notifications" color="inherit" className='me-3 me-lg-0' onClick={handleAvatarClick}>
                    <Badge count={notificationCount}>
                        <Avatar onClick={notification1} src={require("../../Assets/images/Bell-icon.png")} alt="" />
                    </Badge>
                </IconButton>
            </Tooltip>
            ...
            <Avatar src={userDetails.profileImageUrl} size={64} style={{ width: '100%' }} />
        </div>
    );
}
