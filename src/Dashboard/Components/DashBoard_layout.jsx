...
const items = [
  ...
  getItem('Logout', '12', <FileOutlined />),
];
        ...
        <Header className="bg-transparent p-0">
          <div className="d-flex justify-content-between align-items-center header-align">
            <Button
              ...
              onClick={toggleSider}
            >
              <span style={{color:'white', fontSize:'15px'}}>Slider</span> <MenuOutlined />
            </Button>
          </div>
        </Header>
